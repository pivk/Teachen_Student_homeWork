...
<body>
	<div class="admin-content">
		...
		<div class="am-topbar">
			<form id="form" class="am-topbar-form am-topbar-left am-form-inline">
				<input type="hidden" id="FirstRoleId"
					value="<%=request.getAttribute("id")%>">
				<div class="am-form-group" >
					<select id="xueqi" name="xueqi" data-am-selected="{btnSize: 'sm'}">
	...
	<script src="/system/course/power.js"></script>
</body>
</html>