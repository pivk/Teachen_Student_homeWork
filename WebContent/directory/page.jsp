...
<body>
			...
			<div class="admin-content-body">
				...
				<div class="am-topbar">
					...
					<select id="xueqi" name="xueqi"
						...
						<option value="2017-2018上学期" selected="selected">2017-2018上学期</option>
					...
					<button id="btQuery" type="button" class="am-btn am-btn-primary am-radius"
						style="margin-left: 5px">
						<span class="am-icon-search"></span>查询
					</button>
					<button id="btCreateDirectory" type="button" class="am-btn am-btn-primary am-radius">
						<span class="am-icon-create"></span>创建文件夹
					</button>
					</form>
				</div>
	...
	<script src="/directory/page.js"></script>
</body>
</html>