...
<body>
					...
					<form id="form"
						...
						<div class="am-form-group">
							<input id="biaoti" name="biaoti" type="text"
								class="am-form-field am-input-sm" placeholder="通知标题" maxlength="25">
						</div>
						...
						<table id="table"
							...
							<thead>
								<tr>
									...
									<th class="table-set" style="width: 200px">操作</th>
								</tr>
							</thead>
							<tbody>
	...
	<script src="/information/noticeAdminPage.js"></script>
</body>
</html>