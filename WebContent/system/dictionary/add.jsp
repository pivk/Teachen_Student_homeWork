...
<body>
			...
			<div class="admin-content-body">
				...
				<form id="form" class="am-form" >
					<div class="am-g am-margin-top">
						<div class="am-u-sm-4 am-u-md-2 am-text-right"><span style="color:red">*&nbsp;</span>类别</div>
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<select  required id="lei" name="lei" data-am-selected >
							</select>
						</div>
					</div>
					<div class="am-g am-margin-top">
						<div class="am-u-sm-4 am-u-md-2 am-text-right">键</div>
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input id="jian" name="jian" type="text" class="am-input-sm" maxlength="10">
						</div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<textarea id="zhi" name="zhi" rows="5" class="am-input-sm" maxlength="50"></textarea>
						</div>
					</div>
					<div class="am-g am-margin-top">
						<div class="am-u-sm-4 am-u-md-2 am-text-right">序号</div>
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input id="xu" name="xu" type="text" class="am-input-sm" maxlength="11">
						</div>
					</div>
	...
	<script src="/system/dictionary/add.js"></script>
</body>
</html>