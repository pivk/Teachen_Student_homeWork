...
<body>
		<div class="admin-content">
			<div class="admin-content-body">
				...
				<form id="form" class="am-form" >
					...
					<input id="oldmingCheng" name="oldmingCheng" type="hidden"/>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input id="mingCheng" name="mingCheng" type="text" required maxlength="20"
								class="am-input-sm"  >
						</div>						
					</div>
				...
				<!-- 			<select id="unitId" name="parentId">
				      ...
				      <input type="text" class="am-input-sm am-form-field"  id="parentName" disabled>				
						</div>
					</div>
	...
	<script src="/system/unit/edit.js"></script>
</body>
</html>