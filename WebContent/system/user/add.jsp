				...
				<form id="form" class="am-form">
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input id="id" name="id" type="text" class="am-input-sm" required maxlength="25"/>
						</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input id="xingMing" name="xingMing" type="text" maxlength="25"
								class="am-input-sm">
						</div>
					</div>
					<div class="am-g am-margin-top">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<select id="unitId" name="unitId" data-am-selected
