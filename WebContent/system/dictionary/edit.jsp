...
<body>
				...
				<input id="id" name="id" type="hidden" value="${id}" />
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<select  id="lei" name="lei"  required>
							</select>
						</div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input id="jian" name="jian" type="text" class="am-input-sm">
						</div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<textarea id="zhi" name="zhi" rows="5" class="am-input-sm"></textarea>
						</div>
					</div>
					<div class="am-g am-margin-top">
						<div class="am-u-sm-4 am-u-md-2 am-text-right">序号</div>
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input id="xu" name="xu" type="text" class="am-input-sm">
						</div>
					</div>
	...
	<script src="/system/dictionary/edit.js"></script>
</body>
</html>